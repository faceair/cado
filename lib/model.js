  ...
  _createClass(Model, [{
    ...
    value: function query(method) {
      ...
      if (_lodash2.default.isArray(records)) {
        instances = records.map(function (record) {
    ...
    key: 'findBySort',
    value: function findBySort(query, sort) {
      return _lodash2.default.sortBy(this.find(query), sort);
    }
  }, {
    key: 'findOne',
    ...
    value: function findById(id) {
      var instance = null;
      if (_lodash2.default.isNumber(id)) {
